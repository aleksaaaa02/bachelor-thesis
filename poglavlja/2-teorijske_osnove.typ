...
Подразумевани скриптни језик у _Godot_-у је _GDScript_, који је синтаксно сличан Пајтон-у и намењен је брзом развоју логике. Ипак за пројекте који захтевају високе перформансе или ближи контакт са системским ресурсима, постоји могућност коришћења других програмских језика преко повезница (енг. _bindings_) система. _Godot_ је претежно писан у C++ језику, па су повезнице за овај програмски језик релативно документовани и подржани, док за језик попут _Rust_-а и подршка и документација су доста слабији.
...
- Сервер за аутентификацију (енг. _authentication server_) - представља независан модул који верификује играча пре приступа серверу за игру, чиме се обезбеђује контролисани приступ и омогућава распоређивање играча у сесије.
...
- Основне функционалности игре који обухвата:
