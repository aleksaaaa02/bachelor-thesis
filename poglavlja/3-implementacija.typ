...
Кориснички подаци се чувају у _PostgreSQL_ бази података, при чему се лозинке хешују (енг. _hashing_) како би се повећала безбедност. При свакој успешној прајви, сервер враћа иднетификатор, који клијент касније користи за идентификацију током комуникације са сервером игре. Овај приступ је поједностављен и погодан за развојну фазу система, јер омогућава једноставну интеграцију са клијентом.
