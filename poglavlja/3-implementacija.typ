...
- Ако неко од активних играча има 0 животних бодова, сматра се да је он уништен и иницијализује се на нову позицију.
- Иницијализују астероиде ако постоје услови за то. Конкретно астероиде инцијализујемо након сваких 1000 ms како не бисмо преплавили игру астероидима. Ово је такође нешто што се може прилагодити.
...
Кориснички подаци се чувају у _PostgreSQL_ бази података, при чему се лозинке хешују (енг. _hashing_) како би се повећала безбедност. При свакој успешној пријави, сервер враћа иднетификатор, који клијент касније користи за идентификацију током комуникације са сервером игре. Овај приступ је поједностављен и погодан за развојну фазу система, јер омогућава једноставну интеграцију са клијентом.
