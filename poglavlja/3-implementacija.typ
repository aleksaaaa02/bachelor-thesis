...
_Game server_ је ауторитативан сервер на коме се врши симулација света игре. При покретању, сервер отвара два сокета (енг. _socket_), један од њих је намењен за комуникацију преко TCP-a док је други намењен за комуникацију преко UDP-a. Комуникација преко мреже, односно операције читања и писања порука, могу бити дуге и блокирајуће операције. Ово се може решити ако сервер имплементирамо као вишенитни сервер (енг. _multi-threaded_). Коришћењем _Tokio_ сандука можемо раздвојити обраду порука у одвојене асинхроне задатке. Конкретни асинхрони задаци подразумевају:
...
Поред имплементације интерфејса за одређену _Godot_ класу, могу се дефинсати и додатне методе унутар имплементационог блока дефинисане структуре.

=== Мрежна комуникација

RustyArena поседује две структуре чији је фокус омуникација са серверима. Прва структура је _NetworkClient_ који се користи за комуникацију са сервером на коме се игра симулира. При покретању игре учитава се адресе на којима се налазе сервери. Код у листингу @list:serverkonekcija представља имплементацију отварања сокета за UDP комуникацију. За адресу наведена је локална адреса (0.0.0.0), док је за је постављена нула што означава коришћење било ког слободног порта.
